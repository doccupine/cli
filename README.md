...
- **Lean icons** - only the Lucide glyphs your pages, navigation, footer links, and components use are bundled; an unknown icon name warns when the site is generated and renders nothing
