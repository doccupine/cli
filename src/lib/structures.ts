...
import { variantSwitchersTemplate } from "../templates/components/layout/VariantSwitchers.js";
import { dropdownTemplate } from "../templates/components/layout/Dropdown.js";
import { useVariantTemplate } from "../templates/components/useVariant.js";
import { useStringsTemplate } from "../templates/components/useStrings.js";
import { variantsUtilTemplate } from "../templates/utils/variants.js";
import { stringsUtilTemplate } from "../templates/utils/strings.js";
...
import { platformLanguagesMdxTemplate } from "../templates/mdx/platform/languages.mdx.js";
import { platformVersionsMdxTemplate } from "../templates/mdx/platform/versions.mdx.js";
import { languagesMdxTemplate } from "../templates/mdx/languages.mdx.js";
import { versionsMdxTemplate } from "../templates/mdx/versions.mdx.js";
...
export const appStructure: Record<string, string> = {
  ...
  "utils/variants.ts": variantsUtilTemplate,
  "utils/strings.ts": stringsUtilTemplate,
  ...
  "components/useVariant.ts": useVariantTemplate,
  "components/useStrings.ts": useStringsTemplate,
  ...
  "components/layout/Dropdown.tsx": dropdownTemplate,
  ...
  "components/layout/VariantSwitchers.tsx": variantSwitchersTemplate,
};
...
export const startingDocsStructure: Record<string, string> = {
  ...
  "languages.mdx": languagesMdxTemplate,
  "versions.mdx": versionsMdxTemplate,
  ...
  "platform/languages.mdx": platformLanguagesMdxTemplate,
  "platform/versions.mdx": platformVersionsMdxTemplate,
